...
export default class DatePicker extends Component {
  ...
  __HandlerKeyPress(event) {
    if ((event.charCode >= 48 && event.charCode <= 57) || event.charCode === 8 || event.charCode === 13) {
  ...
  __HandlerBlur(type) {
    ...
    this.setState({ __index: this.state.__index += 1 });
  }
  ...
  __HandlerArrow(direction, ctrl) {
    ...
    } else if (value === 0 && direction !== 'up') { // 小时
      __txt.value = 23;
              ...
              <div className={dStyle.timeContentCenter}>
                <div className={dStyle.item}>
                  ...
                  <div className={dStyle.value}>
                    <input type="text" ref="txtHour" maxLength="2" onKeyDown={this.__HandlerKeyDown.bind(this)}
                      defaultValue={Hour || value.getHours()} onKeyPress={this.__HandlerKeyPress.bind(this)}
                ...
                <div className={dStyle.item}>
                  ...
                  <div className={dStyle.value}>
                    <input type="text" ref="txtMinute" maxLength="2" onKeyDown={this.__HandlerKeyDown.bind(this)}
                      defaultValue={Minute || value.getMinutes()}
